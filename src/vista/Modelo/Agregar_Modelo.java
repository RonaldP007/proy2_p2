 ...
 * @author Enrique
 */
public class Agregar_Modelo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblModelo.setText("Nombre del nuevo modelo:");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(!txtModelo.getText().equals("")){
            ...
            agregado = crud_cod.Agregar_Modelo_Cod(txtModelo.getText());
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_Modelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Agregar_Modelo dialog = new Agregar_Modelo(new javax.swing.JDialog(), true);
